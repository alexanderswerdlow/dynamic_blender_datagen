...
# echo 'mv /.default_config /.config' >> singularity/sandbox/.singularity.d/runscript
...
# singularity shell --bind $(pwd)/singularity/config:/.config --nv singularity/blender_binary.sig
